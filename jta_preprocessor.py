...
class JTAPreprocessor():
    def __init__(self, dataset_path,custom_name=None):
        ...
        # Fixed variablesme_num = 900
        self.use_video_once = False
            ...
            with open(entry.path, 'r') as json_file:
                ...
                for i in range(1, self.dataset_total_frame_num+1):
                   # get specific frame
                    ...
                    ped_data = np.array([frame_num, ID, x, y, z, width, height, depth]).T
                ...
                data_to_write.filename = data_to_write.filename.apply(lambda x: '%04d'%int(x)+'.jpg')
                #data_to_write.ID = data_to_write.ID.apply(lambda x: 'pedestrian'+'%d'%int(x))
...
if __name__ == '__main__':
    ...
    path = 'C:/Users/Celinna/Desktop/ROBMSC3/VITA/JTA'
